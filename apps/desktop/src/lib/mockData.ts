...
const mockIssues: IssueSummary[] = [
  {
    ...
    title: "左右端候选需复核",
    summary: "配对置信度未达自动通过阈值。",
    explanation: "左右端均有候选，但分差过小。",
    recommended_action: "核对两端端子，对比邻近竞争候选。",
    severity: "review",
    status: "open",
    confidence: 0.74,
    sheet_id: "S0005",
  ...
  },
  {
    ...
    title: "源端子一对多扇出",
    summary: "一对多簇需按分支语义复核。",
    explanation: "多目标共享同一源值，上下文不足自动判定。",
    recommended_action: "对照关联图纸，确认是否合法分支。",
    severity: "major",
    status: "ignored",
    confidence: 0.91,
    sheet_id: "S0008",
  ...
  },
  {
    ...
    title: "跨页映射冲突",
    summary: "跨页映射冲突，风险高。",
    explanation: "同一源值在不同图纸映射到不同目标。",
    recommended_action: "优先复核相关图纸，确认权威目标。",
    severity: "critical",
    status: "resolved",
    confidence: 0.96,
    sheet_id: "S0012",
