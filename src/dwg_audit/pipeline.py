...
def analyze_input_root(input_path: Path, output_path: Path, config: dict, logger) -> list[Path]:
    ...
    for project_root in project_roots:
        ...
        convert_source_files(scan.manifest.source_files, output_path, config, logger)
        ...
        line_groups = build_line_groups(audit_lines, audit_pages, config)
